/*
  ...
  - You are about to alter the column `heureDeconnection` on the `User` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
...
CREATE TABLE "new_User" (
    ...
    "heureDeconnection" INTEGER NOT NULL,
